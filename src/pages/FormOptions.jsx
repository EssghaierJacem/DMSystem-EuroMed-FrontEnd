                    ...
                    <div className="row g-md-5 g-4">
                        <div className="col-lg-6 order-lg-0 order-1">
                            <div className="about-content">
                                ...
                                <Link to="#" className="btn-arrow" onClick={(e) => { e.preventDefault(); handleButtonClick('/predefined-form'); }}>
                    ...
                    <div className="row g-md-5 g-4">
                        ...
                        <div className="col-lg-6">
                            <div className="about-content">
                                ...
                                <Link to="#" className="btn-arrow" onClick={(e) => { e.preventDefault(); handleButtonClick('/form'); }}>
                                    <div className="icon-arrow">
                                        <i className="iconsax" data-icon="arrow-up"></i>
                                    </div>
